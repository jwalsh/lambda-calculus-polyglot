...
lc_four = lc_succ(lc_three)
lc_five = lc_succ(lc_four)
lc_six = lc_succ(lc_five)
lc_seven = lc_succ(lc_six)
lc_eight = lc_succ(lc_seven)
lc_nine = lc_succ(lc_eight)
lc_ten = lc_succ(lc_nine)
...
if __name__ == "__main__":
    ...
    print("Factorial of 5:",
          church_to_int(factorial(lc_add(lc_two)(lc_succ(lc_two)))))
